...
import com.example.projecttabs.DrumsWithoutCursor;
import com.example.projecttabs.MainActivity;
import com.example.projecttabs.R;
import com.example.projecttabs.TactCursor;
...
public class PlayDrums extends AppCompatActivity {
    private final File file = new File("/storage/emulated/0/download/Ball3.mid");
    MidiFile midiFile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<MidiEvent> events = new ArrayList<MidiEvent>(tracks.get(12).getEvents());
        ...
        playButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(PlayDrums.this, Uri.fromFile(file));
        ...
        returnButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.stop();
                isPlay = false;
                Intent intent  = new Intent(PlayDrums.this, MainActivity.class);
    ...
    private void updateLine(int resolution, boolean direction){
        line = new DrumsWithoutCursor(PlayDrums.this);
        ...
        line.setData(map.get(n), nominator, denominator, resolution, n + 1);
        if (currentTact) {
    ...
    private void initialSetup(int resolution){
        ...
        line = new DrumsWithoutCursor(this);
        line.setData(map.get(n), nominator, denominator, resolution, 1);
        line1.removeAllViews();
        line1.addView(line);
        line = new DrumsWithoutCursor(this);
        if (map.size() > 1){
            line = new DrumsWithoutCursor(this);
            line.setData(map.get(n), nominator, denominator, resolution, 2);
            line2.removeAllViews();
            line2.addView(line);
