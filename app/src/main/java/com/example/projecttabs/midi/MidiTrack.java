...
import com.example.projecttabs.midi.event.meta.EndOfTrack;
...
public class MidiTrack
{
    ...
    public boolean removeEvent(MidiEvent E)
    {
        ...
        while(it.hasNext())
        {
            ...
            if (curr != null)
                if(E.getTick() == curr.getTick() && E.getNote() == curr.getNote()
                        && E.getVelocity() == curr.getVelocity() && E.getChannel() == curr.getChannel())
                {
                    break;
                }
