...
package com.example.projecttabs.midi.event.meta;
...
import com.example.projecttabs.midi.util.VariableLengthInt;
import com.example.projecttabs.midi.event.MidiEvent;
...
public abstract class MetaEvent extends MidiEvent
{
    ...
    //public MetaEvent(long tick, long delta, int timeSignature, VariableLengthInt variableLengthInt) {
    //    super(tick, delta);
    //}
    ...
    public static MidiEvent parseMetaEvent(long tick, long delta, InputStream in) throws IOException
    {
