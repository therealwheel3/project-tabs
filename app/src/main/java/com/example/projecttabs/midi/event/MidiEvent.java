...
package com.example.projecttabs.midi.event;

import com.example.projecttabs.midi.event.meta.MetaEvent;
...
public abstract class MidiEvent implements Comparable<MidiEvent>
{
    ...
    public int getNote(){return 1;}
    public int getVelocity(){return 1;}
